...
[![arXiv](https://img.shields.io/badge/arXiv-2605.31443-b31b1b.svg)](https://arxiv.org/abs/2605.31443)

This repository contains the implementation of the [ICML 2026](https://icml.cc/Conferences/2026) paper, "Modeling Covariate Transition for Efficient Estimation of Longitudinal Treatment Effects in Randomized Experiments
," by Naoki Chihara, Tatsushi Oka, Yasuko Matsubara, Yasushi Sakurai, and Shota Yasui.
...
2. Construct a virtual environment and install the required packages.
    ...
    - If you prefer not to use them, you can also use [`requirements.txt`](https://github.com/C-Naoki/dynamic-adjustment/blob/main/requirements.txt) created based on [`pyproject.toml`](https://github.com/C-Naoki/dynamic-adjustment/blob/main/pyproject.toml).
    ...
    3. install packages in [`pyproject.toml`](https://github.com/C-Naoki/dynamic-adjustment/blob/main/pyproject.toml).
    4. attach the path file (i.e., `*.pth`) in the `site-packages/` for extending module search path.

    Please check the [`Makefile`](https://github.com/C-Naoki/dynamic-adjustment/blob/main/Makefile) for more details.
